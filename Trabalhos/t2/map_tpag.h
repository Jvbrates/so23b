...
//
/* NÃO ALTERA A MEMÓRIA OU A TABELA DE PÁGINAS,
...
/* Substitui uma página(mapeamento de página), pela página(map_node) passada como argumento,
 * retorna a página retirada
 * */
